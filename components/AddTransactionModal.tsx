...
export const AddTransactionModal: React.FC<AddTransactionModalProps> = ({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave({ 
      name: name || (type === TransactionType.TRANSFER ? 'Transfer' : ''), 
      date, 
  ...
  const getAmountLabels = (t: TransactionType) => {
    switch (t) {
      ...
      case TransactionType.TRANSFER:
        return { actual: 'Transfer Amount', planned: '' };
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input 
                  type="text" 
                  required 
                  placeholder={type === TransactionType.TRANSFER ? "e.g. Monthly Savings Transfer" : "e.g. Monthly Rent, Grocery Store..."}
              ...
              <div className={`grid ${type === TransactionType.TRANSFER ? 'grid-cols-1' : 'grid-cols-2'} gap-4`}>
                <div>
